...
document.addEventListener("keydown", warpHandler, false);
...
class Game {
  ...
  draw(ctx) {
    ...
    if (warpPressed) {
      warpPressed = false
      this.ball.ballPosX = 123
      this.ball.ballPosY = 123
      this.ball.ballVelX = (this.ball.ballVelX % 2) + 1
      this.ball.ballVelY = (this.ball.ballVelY % 2) + 1
